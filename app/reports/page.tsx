  ...
  useEffect(() => {
    ...
    const unsubscribe = onSnapshot(
      ...
      (snapshot) => {
        ...
        setTransactions(txs);
        setReports(generateMonthlyReports(txs));
      ...
      (error) => {
        ...
        if (error.code === "permission-denied") {
          console.log(
            "%c TRANSACTIONS PERMISSION DENIED (Reports)",
          ...
          reports.map((report) => (
            ...
            >
              <div className="bg-stone-900 p-6 text-white">
                ...
                <div className="flex gap-4 mt-4">
                  <div className="flex-1">
                    <p className="text-[10px] text-stone-400 uppercase tracking-tighter mb-1">
                      Total Income
                    </p>
              ...
              <div className="p-6 space-y-6">
                <div>
                  <p className="text-[10px] text-stone-400 uppercase tracking-widest mb-3 border-b border-stone-100 pb-1">
                    Income Breakdown
                  </p>
...
function ReportItem({
  ...
  return (
    <div
      className={isHighlight ? "col-span-2 pt-4 border-t border-stone-100" : ""}
    >
